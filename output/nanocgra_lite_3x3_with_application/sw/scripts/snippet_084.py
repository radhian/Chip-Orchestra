...
# ---------- mmio_bus ----------
vecs=[]
# (addr, wr, rd, wdata, sram_rdata, uart_rdata, cgra_rdata)
bus_cases = [
  (0x10,0,1,0,0x42,0,0),
...
for addr,wr,rd,wdata,sr,ur,cr in bus_cases:
    ...
    vecs.append({"inputs":{"clk":1,"rst_n":1,"mst_addr":addr,"mst_wr":wr,"mst_rd":rd,
                 ...
                 "expected":o})
b=MMIOBus(); b.reset()
o=b.step(1,0,0,0,0,0,0,0,0)  # 9 args: clk,rst_n,mst_addr,mst_wr,mst_rd,mst_wdata,sram_rdata,uart_rdata,cgra_rdata
