# Let me update the golden model to match the new STOP->START behavior
new_model = '''"""uart_tx — UART transmitter (byte -> serial).
...
with open('golden/model/uart_tx.py', 'w') as f:
    f.write(new_model)
print("Golden model updated")