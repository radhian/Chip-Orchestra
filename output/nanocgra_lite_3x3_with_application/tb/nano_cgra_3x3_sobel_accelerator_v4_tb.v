...
module nano_cgra_3x3_sobel_accelerator_v4_tb;
    ...
    // ---- Golden output (loaded from waves/golden_output.mem) ----
    ...
    initial begin
        ...
        // ---- Dump waves ----
        $dumpfile("design.vcd");
        $dumpvars(0, nano_cgra_3x3_sobel_accelerator_v4_tb);
        ...
        $display("Chip output written to waves/chip_output.mem (%0d values)", n_captured);
