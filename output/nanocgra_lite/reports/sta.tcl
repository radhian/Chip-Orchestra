#==============================================================================
# Post-route STA report for NanoCGRA_Lite
#==============================================================================
...
read_db output/nanocgra_lite/pnr/nanocgra_lite.odb
...
puts "=================================================================="
puts "  NanoCGRA_Lite  --  Static Timing Analysis (tt_025C_5v00, 100 ns)"
puts "=================================================================="
