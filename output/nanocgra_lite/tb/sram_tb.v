//============================================================================
// sram_tb.v  -  Testbench for the 128B single-port SRAM.
...
module sram_tb;
    ...
    sram #(.DW(DW), .AW(AW), .DEPTH(128)) dut (
    ...
    initial begin
        ...
        sram_write(7'd0,   8'd42);
        sram_write(7'd1,   8'd100);
        sram_write(7'd127, 8'd255);
        sram_write(7'd64,  8'd7);

        sram_check(7'd0,   8'd42);
        sram_check(7'd1,   8'd100);
        sram_check(7'd127, 8'd255);
        sram_check(7'd64,  8'd7);

        // Overwrite test
        sram_write(7'd0, 8'd200);
        sram_check(7'd0, 8'd200);
