...
> This deck is a Markdown "slide" document. Each `---` separates a slide. All diagrams
> are Mermaid and render natively on GitHub.

---

## Slide 0 · TL;DR — the one-slide version
...
## Slide 1 · Why we built Chip Orchestra
...
flowchart LR
    ...
    Q2["✅ Can AI orchestrate the entire<br/>RTL-to-GDSII journey while keeping<br/>engineers in control?"]
...
## Slide 2 · The system today (what already works)
...
## Slide 3 · Why AMD — and why "fully AMD" is a genuine differentiator
...
## Slide 4 · Why Efison — the mutual benefit
...
## Slide 5 · Market position — where the money and the moats are
...
## Slide 6 · How we differentiate (feature-level)
...
## Slide 7 · Product & development roadmap
...
## Slide 8 · Opportunity map — benefit vs. cost vs. risk
...
## Slide 9 · Challenges & tradeoffs (the honest slide)
